            ...
            <div id="public-class-live">
                ...
                <div style="width:110%;">
                    <ul class="public-class-live-content clearfix">
                        @foreach($live as $val)
                        <li>
                            <a style="cursor:pointer" href="{{route('live')}}?id={{$val -> id}}" target="_blank">
                ...
                <div id="log" style="width: 100%;">
                    <div id="content" class="content clearfix" style="width: 110%;">
                        ...
                        <div class="course clearfix">
                            <a href="/profession?id={{$val -> id}}" target="_blank">
                                ...
                                <div class="detail">
                                    ...
                                    <p class="info clearfix"><span><i>￥</i><span class="price">{{$val -> price * 0.0001}}</span>
                                        ...
                                        </span><span class="stuCount"><img src="/home/img/studentCount.png" alt=""><span class="studentCou">{{$val -> view_count}}
                                </div>
                            </a>
                        </div>
                        @endforeach
