...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="4">角色管理</th>
			</tr>
			<tr class="text-c">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$val -> role_name}}</td>
				<td class="f-14">
					<a title="分派权限" href="javascript:;" onclick="admin_assign('分派权限','{{route('role_assign')}}','{{$val->id}}','','400')" style="text-decoration:none"><i class="Hui-iconfont">&#xe63c;</i></a> 
